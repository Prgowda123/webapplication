...
public void sample1() throws InterruptedException, AWTException, ParseException
{
    ...
    try {
		// Reading Excel File
		FileInputStream fis1 = new FileInputStream("D://Automation_data//TestDataAPC_NKK.xlsx");//"D:\steno\TestDataAPC.xlsx"
	...
	act.moveToElement(SSLC).perform();
		   ...
		   WebElement appdetails = driver.findElement(By.xpath("//h5[@id='exampleModalCenterTitle']"));
			...
			if(!isElementClickable(driver, appdetails)) {try {
			    ...
			    String[] errorIds = {"Applicant_ApplyingTypeCode-error","Applicant_PostUnitCode-error",
			        ...
			        "Applicant_EmailId-error", "Applicant_MobileNo-error", "Applicant_AadharNo-error", "ApplicantCategory-error","ApplicantDob-error",
			        ...
			        "Applicant_PermanentAddress_OtherDistrictName-error","Applicant_PermanentAddress_Pincode","Applicant_PermanentAddress_Landmark-error","ApplicantGovtJoining-error","Applicant_Reservation_GovermentServiceDetail_MonthsInService-error",
			      ...
			      "Applicant_EducationalQualification_SSLCQualification_QualificationBoardCode-error","Applicant_EducationalQualification_SSLCQualification_KannadaLanguagePaper-error","Applicant_EducationalQualification_SSLCQualification_YearOfPassing-error",
			      "Applicant_EducationalQualification_PUCQualification_QualificationBoardCode-error","Applicant_EducationalQualification_PUCQualification_YearOfPassing-error",
    ...
    System.out.println(i +" iteration succesfully completed ");
		...
		fileOut = new FileOutputStream("D://Automation_data//TestDataAPC_NKK.xlsx");
