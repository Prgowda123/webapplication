...
public void sample() throws AWTException, InterruptedException, IOException
{
    ...
    WebElement KalyanaKarnataka = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[contains(text(),'Do you have 371J Kalyana Karnataka Certificate')]")));
    String Kalyana_Karnataka = KalyanaKarnataka.getText();
    ...
    jss.executeScript("arguments[0].scrollIntoView(true);", KKJ);
    Thread.sleep(500);
    WebElement KKCertificate = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[contains(text(),'Are you applying for getting')]")));
    String KK_Certificate = KKCertificate.getText();
   ...
   //degree
	...
	XSSFWorkbook workbook = new XSSFWorkbook(fis1);
	 ...
	 row1.createCell(54).setCellValue(Kalyana_Karnataka);
	 row1.createCell(55).setCellValue(KK_Certificate);
